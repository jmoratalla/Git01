...
<?php
  ...
  $rows = $mipdo->execute("SELECT id_menu as menu_item_id, parent_id as menu_parent_id, title as menu_item_name,concat('/foldername',url)as url,menu_order,icon FROM dynamic_menu ORDER BY menu_order");
    $refs = array();
    $list = array();
